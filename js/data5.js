...
const READING_TEXT_ZH = {
  r7: '你好！我叫王林，来自北京。我十九岁，是大学一年级学生。我学西班牙语，因为我觉得它是一门很美的语言。我们班有二十名学生。我的老师叫安娜，是西班牙人。她非常和善、有耐心。我们每天有两小时西班牙语课。虽然西班牙语不容易，但我很喜欢，学得满怀热情。',
  r1: '我叫劳拉，是个学生。每天早上七点起床。早餐吃牛奶咖啡和面包。我坐地铁去大学。上午有三节课。两点和朋友们在餐厅吃午饭。下午在图书馆学习。晚上在家和家人吃晚饭，看一会儿电视。十一点睡觉。',
  r8: '我们的外语系很大。有许多教室、一座图书馆和一间语言实验室。我们这些学生学英语、法语、西班牙语或德语。上午有课，下午在图书馆学习。图书馆有很多书和词典。有时我们在实验室听录音来练习发音。我很喜欢我的系，因为老师们都很好，同学们也很友善。',
  r2: '我住在一座又大又漂亮的城市。这里有很多公园、商店和餐馆。市中心有一座非常有名的博物馆。周末我喜欢在广场散步。我这座城市的人非常友善。春天天气好，但夏天很热。我很喜欢住在这里，因为从不觉得无聊。',
  r9: '去年夏天我和家人去西安度假。我们上午坐火车，下午到达。我们在那里待了一周。参观了著名的兵马俑，品尝了当地的特色菜。有一天下大雨，我们没法出门，就待在酒店里打牌。尽管如此，我们还是玩得很开心。回到家时，我们又累又非常高兴。',
  r3: '上个星期六天气很好。上午我和妈妈去了市场，买了水果和蔬菜。午饭后，我们去看电影，看了一部很有趣的西班牙电影。晚上，几个朋友来家里，我们一起吃了晚饭。我们过得很开心。星期天我休息、读了一本书，还给爷爷奶奶打了电话。这是一个平静但非常惬意的周末。',
  r10: '昨天是我朋友玛尔塔的生日，我们办了一个惊喜派对。我们准备了饭菜、买了蛋糕，还用气球装饰了客厅。玛尔塔一到，大家就喊“惊喜！”，她非常开心。我们吃、跳舞、唱歌，一直到很晚。每个人都送了她礼物。我送了她一本书，因为我知道她特别爱看书。那是难忘的一夜，玛尔塔向我们所有人道了谢。',
  r4: '今天早上巴勃罗感觉不舒服，于是去看医生。他发烧、咳嗽，喉咙也痛。医生给他做了检查，说是流感。给他开了些药，并建议他休息、多喝水。巴勃罗在药店买了药，回了家。休息两天后，他开始感觉好多了。',
  r11: '如今科技几乎渗透到我们所做的一切之中。多亏了手机，我们能在几秒内与世界各地的人联系。互联网让我们足不出户就能学习、工作和购物。然而，一些专家认为我们过于依赖屏幕。重要的是学会适度使用科技，别忘了与他人面对面交谈。科技应当帮助我们，而不是控制我们。',
  r5: '如今，学习语言非常重要。当你掌握另一门语言时，就能和更多人交流，更好地理解其他文化。许多年轻人学英语，但越来越多的人开始学西班牙语，因为它是世界上使用人数最多的语言之一。学一门语言并不容易：必须每天练习，且不要害怕犯错。然而，努力总会带来好结果。',
  r12: '每年都有许多年轻人决定出国留学。在异国生活并不总是容易：起初会想念家人，还得适应不同的文化。然而，这是一段值得的经历。在国外学习，语言学得快得多，还能结识来自世界各地的人。此外，人会变得更独立、更成熟。尽管会有困难，大多数学生都说他们愿意再来一次。',
  r6: '环境是我们社会中一个非常重要的话题。空气和水的污染在许多城市都是严重问题。科学家说，我们必须改变生活方式来保护自然。每个人都能出一份力：比如，回收垃圾、少开车、节约能源。如果我们都齐心协力，就能为子孙后代建设一个更洁净、更健康的未来。',
  r13: '社交网络彻底改变了我们相互交往的方式。多亏了它们，我们能和住得很远的朋友保持联系，并即时了解世界上发生的事。不过，许多专家提醒，过度使用可能引发焦虑和孤立。至关重要的是，年轻人要学会保护自己的隐私，不要轻信在网上读到的一切。尽管这些平台带来诸多便利，但也要记住：真实的生活发生在屏幕之外。归根结底，重要的不是你有多少粉丝，而是你人际关系的质量。',
  r14: '在当今社会，许多人生活匆忙，几乎找不到片刻休息。然而，闲暇和工作一样重要。花上几小时读书、散步或做点爱好，能帮我们减压、恢复精力。心理学家建议时不时放下手机，享受那些让我们快乐的活动。这不是什么都不做，而是要好好选择把时间投入到什么上。懂得休息的人，工作得更好，也活得更平衡。',
